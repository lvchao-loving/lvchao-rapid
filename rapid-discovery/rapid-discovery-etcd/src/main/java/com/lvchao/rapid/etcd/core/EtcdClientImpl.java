package com.lvchao.rapid.etcd.core;

import com.lvchao.rapid.etcd.api.*;
...
public class EtcdClientImpl implements EtcdClient {
    ...
    private static final String ETCD_BASE_COUNTDOWN_WATCHER = "__base__v3";
    ...
    public EtcdClientImpl(String address,
        ...
        if (isCreated.compareAndSet(false, true)) {
            ...
            try {
                ...
                // TODO 添加 ETCD_BASE_COUNTDOWN_WATCHER key 的作用
                KeyValue kv = getKey(ETCD_BASE_COUNTDOWN_WATCHER);
                if (kv == null) {
                    putKey(ETCD_BASE_COUNTDOWN_WATCHER, ETCD_BASE_COUNTDOWN_WATCHER);
                }
