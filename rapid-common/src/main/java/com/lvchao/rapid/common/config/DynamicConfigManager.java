...
public class DynamicConfigManager {
	 ...
	 */
	private ConcurrentHashMap<String /* uniqueId = 【serviceId + : + version】 */ , ServiceDefinition>  serviceDefinitionMap = new ConcurrentHashMap<>();

	/**
	 * 服务的实例集合：uniqueId与一对服务实例对应
	 * 作用：
	 * 		1.当前数据集可以做 LoadBalance；
	 * 		2.；
	 */
	private ConcurrentHashMap<String /* uniqueId = 【serviceId + : + version】 */ , Set<ServiceInstance>> serviceInstanceMap = new ConcurrentHashMap<>();
