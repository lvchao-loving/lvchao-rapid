...
abstract class ConditionAbstract implements Condition {
     ...
     * @see com.lvchao.rapid.common.concurrent.queue.mpmc.Condition#awaitNanos(long)
     */
    @Override
     ...
     * @see com.lvchao.rapid.common.concurrent.queue.mpmc.Condition#await()
     */
    @Override
     ...
     * @see com.lvchao.rapid.common.concurrent.queue.mpmc.Condition#signal()
     */
    @Override
    public void signal() {
        queueLock.lock();
